...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    await resend.emails.send({
      from: "SolWork <notifications@solwork.app>",
      to: [to],
      subject,
      html: `
        <div style="font-family: system-ui, -apple-system, sans-serif; max-width: 480px; margin: 0 auto; background: #080B14; color: #F1F5F9; padding: 32px; border-radius: 12px;">
          <h2 style="color: #7C3AED; margin: 0 0 8px;">SolWork</h2>
          ...
          <p style="color: #6B7280; font-size: 12px; margin: 0;">Powered by SolWork &mdash; Trustless Freelance on Solana</p>
        </div>
      `,
    });
